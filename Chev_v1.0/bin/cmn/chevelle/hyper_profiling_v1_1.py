...
class HyperProfiling:
    ...
    def update_message_queue(message, token):
        """Sends profiling status to chevelle outbound message queue"""
    ...
    def get_url(cls, endpoint):
        ...
        if cls._endpoint_env == 'dev':
            ...
            messaging_url = 'https://chevelle-messaging.cp-epg2i.domain.com' + endpoint
            ...
            messaging_url = 'https://chevelle-messaging-test.cp-epg2i.domain.com' + endpoint
            return {'url': url, 'messaging_url': messaging_url}
        elif cls._endpoint_env == 'crt':
            url = 'https://chevelle-micro-qa.cp-epg2i.domain.com' + endpoint
            messaging_url = 'https://chevelle-messaging-qa.cp-epg2i.domain.com' + endpoint
            return {'url': url, 'messaging_url': messaging_url}
        else:
